...
const fs = require("fs");
const prefix = "#";
const devs = ['432678754570207252' , '407452986361774081' , '462006869834203159' , '337182285822558209'];
const adminprefix = "#";
...
client.channels.find('id', '520703238090260480').setName("W");
client.channels.find('id', '520703238090260480').setName("We");
client.channels.find('id', '520703238090260480').setName("Wel");
client.channels.find('id', '520703238090260480').setName("Welc");
client.channels.find('id', '520703238090260480').setName("Welco");
client.channels.find('id', '520703238090260480').setName("Welcom");
client.channels.find('id', '520703238090260480').setName("Welcome");
client.channels.find('id', '520703238090260480').setName("Welcome T");
client.channels.find('id', '520703238090260480').setName("Welcome To");
client.channels.find('id', '520703238090260480').setName("Welcome To T");
client.channels.find('id', '520703238090260480').setName("Welcome To ox");
client.channels.find('id', '520703238090260480').setName("Welcome To Tox");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic C");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic Co");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic Cod");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic Code");
client.channels.find('id', '520703238090260480').setName("Welcome To Toxic Codes");
  }, 4000);
});
